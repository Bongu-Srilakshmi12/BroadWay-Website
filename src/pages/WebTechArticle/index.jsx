    ...
    <>
      <div className="bg-gray-100 flex flex-col font-roboto items-center justify-start mx-auto w-full">
        <div className="flex flex-col items-start justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start max-w-[1200px] mt-10 mx-auto md:px-5 w-full">
            <div className="flex flex-1 flex-col gap-4 items-center justify-start max-w-[900px] px-4 w-full">
              ...
              <div className="flex flex-col gap-6 items-start justify-start w-full">
                <div className="border border-gray-300 border-solid flex flex-col gap-7 items-start justify-start p-4 rounded-[16px] w-full">
                  ...
                  <div className="flex md:flex-col flex-row gap-7 items-start justify-start w-full">
                    <div className="bg-cyan-700 flex flex-col h-40 md:h-auto items-center justify-center py-2 rounded-[16px] w-40">
                      <div className="flex flex-col h-full items-center justify-center p-2 w-full">
                        <Text
                          className="text-5xl sm:text-[38px] md:text-[44px] text-gray-100 w-auto"
                    ...
                    <Text
                      className="flex-1 max-w-[648px] md:max-w-full text-gray-900 text-xl"
                      size="txtRobotoRegular20Gray900"
                    >
                      A grand soap opera of epic proportions, This movie can be
                      a bit talky in some episodes, but the series draws a
                      viewer in with well-defined characters and a multitude of
                      simultaneous stories whose plot turns are generally
                      unpredictable.
                    </Text>
                  </div>
                </div>
                <div className="bg-gray-300 flex md:flex-col flex-row gap-10 items-start justify-start p-4 rounded-[16px] w-full">
                  <div className="flex flex-1 flex-col gap-[26px] items-start justify-start w-full">
                    ...
                    <div className="flex flex-col gap-4 items-start justify-start w-full">
                      <div className="flex flex-row gap-4 items-center justify-start px-4 w-full">
                        <Img
                          className="h-8 w-8"
                          src="images/img_checkmark.svg"
                          alt="checkmark"
                        />
                        <div className="flex flex-1 flex-col items-center justify-center p-2 w-full">
                          <Text
                            className="max-w-[302px] md:max-w-full text-2xl md:text-[22px] text-gray-900 sm:text-xl"
                            size="txtRobotoRegular24Gray900"
                          >
                            Great visual effect very familiar with Lord of the
                            Rings
                          </Text>
                        </div>
                      </div>
                      <div className="flex flex-row gap-4 items-center justify-start px-4 w-full">
                        ...
                        <div className="flex flex-1 flex-col items-center justify-center p-2 w-full">
                          <Text
                            ...
                            size="txtRobotoRegular24Gray900"
                          >
                            Perfectly executed screen play and brilliant writing
                          </Text>
                        </div>
                      </div>
                      <div className="flex flex-row gap-4 items-center justify-start px-4 w-full">
                        ...
                        <div className="flex flex-1 flex-col items-center justify-center p-2 w-full">
                          <Text
                            ...
                            size="txtRobotoRegular24Gray900"
                          >
                            The art direction, acting and incredible sets are
                            breathtaking
                          </Text>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-row gap-4 items-center justify-start px-4 w-full">
                        ...
                        <div className="flex flex-1 flex-col items-center justify-center p-2 w-full">
                          <Text
                            ...
                            size="txtRobotoRegular24Gray900"
                          >
                            Those who love the books will probably geek out on
                            the series.
                          </Text>
                        </div>
                      </div>
              ...
              <div className="border border-gray-300 border-solid flex flex-col gap-4 items-start justify-center py-2 rounded-[16px] w-full">
                ...
                >
                  <div className="flex flex-1 md:flex-1 flex-col gap-3 items-start justify-start my-0 w-auto md:w-full">
                    <Text
                      className="text-2xl md:text-[22px] text-gray-900 sm:text-xl w-auto"
                      size="txtRobotoBold24"
                    >
                    ...
                    <div className="flex md:flex-col flex-row gap-[22px] items-center justify-start w-full">
                      <Img
                        className="h-4 w-[736px]"
                        src="images/img_frame75.svg"
              ...
              <div className="border border-gray-300 border-solid flex flex-col gap-2 items-start justify-start p-4 rounded-[16px] w-full">
                ...
                <Text
                  ...
                  size="txtRobotoRegular20Gray900"
                >
                  we collect information from many stores for best prices
                  available
                </Text>
                <List
                  ...
                  orientation="vertical"
                >
                  <div className="border border-gray-300 border-solid flex flex-1 flex-row sm:gap-10 h-14 md:h-auto items-center justify-between p-2 rounded-lg w-full">
                    <div className="flex flex-row items-center justify-start w-auto">
                      <Img
                        className="h-6 w-6"
                        src="images/img_iamazon.svg"
                        alt="iamazon"
                      />
                      <div className="flex flex-col items-center justify-center p-2 w-auto">
                        <Text
                    ...
                    <div className="flex flex-row gap-2 items-start justify-start w-auto">
                      ...
                      <Button
                        className="cursor-pointer leading-[normal] min-w-[111px] rounded-lg text-center text-xl"
                        color="cyan_700"
                        size="xs"
                        variant="fill"
                      >
          ...
          <Footer className="bg-gray-900 flex items-center justify-center mt-[149px] md:px-5 w-full" />
        </div>
      </div>
    </>
  );
...
export default WebTechArticlePage;
