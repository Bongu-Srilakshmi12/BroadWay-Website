  ...
  return (
    <>
      <div className="bg-gray-100 flex flex-col font-roboto items-start justify-start mx-auto w-full">
        ...
        <div className="flex flex-col items-center justify-start mt-3 p-2 md:px-5 shadow-bs w-[91%] md:w-full">
          <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-[85%] md:w-full">
            ...
            <div className="flex ml-0.5 md:ml-[0] relative w-[29%] md:w-full">
            ...
            <Button
              className="cursor-pointer h-10 leading-[normal] min-w-[61px] ml-0.5 md:ml-[0] text-center text-xl"
              shape="square"
              color="gray_100"
              size="xs"
              variant="fill"
            ...
            <div className="flex ml-0.5 md:ml-[0] relative w-[26%] md:w-full">
            ...
            <Button
              className="cursor-pointer h-10 leading-[normal] min-w-[75px] ml-0.5 md:ml-[0] text-center text-xl"
              shape="square"
              color="gray_100"
              size="xs"
              variant="fill"
            ...
            <Button
              className="cursor-pointer h-10 leading-[normal] min-w-[123px] ml-0.5 md:ml-[0] text-center text-xl"
              shape="square"
              color="gray_100"
              size="xs"
              variant="fill"
            ...
            <SelectBox
              className="h-10 leading-[normal] ml-0.5 md:ml-[0] text-left text-xl w-[10%] md:w-full"
              placeholderClassName="text-gray-900"
              indicator={
                <Img
                  className="h-6 w-6"
        ...
        <div className="flex flex-col items-center mt-3 w-full">
          ...
          <Footer className="bg-gray-900 flex items-center justify-center mt-[25px] md:px-5 w-full" />
        </div>
      </div>
    </>
  );
...
export default WebCitiesHyderabadPage;
