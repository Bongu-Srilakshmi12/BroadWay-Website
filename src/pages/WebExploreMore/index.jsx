  ...
  return (
    <>
      <div className="bg-gray-100 flex flex-col font-roboto items-start justify-start mx-auto w-full">
        ...
        >
          Cafes & Restuarants in Hyderabad
        </Text>
        <div className="flex flex-col gap-10 items-center mt-3 w-full">
          <Text
          ...
          <div className="flex flex-col items-start justify-start max-w-[1200px] mx-auto md:px-5 w-full">
...
export default WebExploreMorePage;
