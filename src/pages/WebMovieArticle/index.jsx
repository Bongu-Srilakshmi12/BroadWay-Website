        ...
        <div className="flex flex-col items-start justify-start w-full">
          ...
          <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start max-w-[1200px] mt-10 mx-auto md:px-5 w-full">
            <div className="flex flex-1 flex-col gap-4 items-center justify-start max-w-[900px] px-4 w-full">
              ...
              <div className="border border-gray-300 border-solid flex flex-col gap-4 items-start justify-center max-w-[850px] py-2 rounded-[16px] w-full">
                ...
                <div className="flex flex-col items-center justify-start w-full">
                  <List
                    className="flex flex-col gap-4 items-center w-[97%]"
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3 items-start justify-start w-auto md:w-full">
                      ...
                      <div className="flex md:flex-col flex-row gap-[22px] items-center justify-start w-auto md:w-full">
                        <Img
                          className="h-4 w-[736px]"
                          src="images/img_frame75.svg"
                          alt="frameSeventyFive"
          ...
          <Footer className="bg-gray-900 flex items-center justify-center mt-[159px] md:px-5 w-full" />
        </div>
      </div>
    </>
  );
...
export default WebMovieArticlePage;
